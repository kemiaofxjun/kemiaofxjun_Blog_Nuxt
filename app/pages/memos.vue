...
<div class="page-essay">
  <div class="talk-container">
    <div id="talk" class="talks-list">
      <div v-for="(item, index) in talkList" :key="index" class="talk_item">
      <!-- 说说元信息 -->
        <div class="talk_meta">
          <img :src="item.avatar" class="no-lightbox avatar" alt="用户头像" >
            <div class="info">
              <span class="talk_nick">
                {{ item.user }} 
                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="is-badge icon">
        ...
        <!-- 说说内容 -->
        <div class="talk_content" v-html="item.content"></div>
             
        <!-- 底部标签 -->
        <div class="talk_bottom">
          <div class="TagContainer">
            <span class="talk_tag">🏷️{{ item.tags.join(' ') }}</span>
            <span class="location_tag">🌍{{ item.location }}</span>
          </div>
