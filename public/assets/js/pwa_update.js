function initialize_fc_lite() {
    ...
    function displayRandomArticle() {
        ...
        randomArticleContainer.innerHTML = `
            ...
            <button class="refresh-btn gradient-card" onclick="window.open('${randomArticle.link}', '_blank')">
                <span class="iconify i-ph:arrows-clockwise" aria-hidden="true" style=""></span>
            </button>
